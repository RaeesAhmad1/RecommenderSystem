...
$.extend($.easing, {
                ...
                return (
                    ...
                    (e.prototype.refresh = function (t, e) {
                        var a = window.pageYOffset + e.offsetTop,
                            i = this.$el;
                        this.refreshSize(),
                            a > this.top && this.isWrap
                                ? ((this.height = i[0].offsetHeight),
                                    i.hasClass("fixed") || i.parent().css("height", this.height + "px"),
                                    i.hasClass("fix-top")
                                        ? (i.css("margin-top", e.offsetTop + "px"), (this.zIndex = this.options.max_index - e.index))
                                        : i.hasClass("fix-bottom")
                                            ? (i.css("margin-bottom", e.offsetBottom + "px"), (this.zIndex = this.options.max_index - e.index))
                                            : i.css({ transition: "opacity .5s", "z-index": this.zIndex }),
                                    this.options.scrollMode
                                        ? ((this.scrollPos >= a && i.hasClass("fix-top")) || (this.scrollPos <= a && i.hasClass("fix-bottom"))
                                            ? (i.addClass("fixed"), this.onFixed && this.onFixed(), i.hasClass("product-sticky-content") && Wolmart.$body.addClass("addtocart-fixed"))
                                            : (i.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""), this.onUnfixed && this.onUnfixed(), i.hasClass("product-sticky-content") && Wolmart.$body.removeClass("addtocart-fixed")),
                                            (this.scrollPos = a))
                                        : (i.addClass("fixed"), this.onFixed && this.onFixed()),
                                    i.is(".fixed.fix-top") ? ((e.offsetTop += i[0].offsetHeight), (Wolmart.sticky_top_height = e.offsetTop)) : i.is(".fixed.fix-bottom") && (e.offsetBottom += i[0].offsetHeight))
                                : (i.parent().css("height", ""),
                                    i.removeClass("fixed").css({ "margin-top": "", "margin-bottom": "", "z-index": "" }),
                                    this.onUnfixed && this.onUnfixed(),
                                    i.hasClass("product-sticky-content") && Wolmart.$body.removeClass("addtocart-fixed"));
                    }),
                            ...
                            Wolmart.$body
                                .on("click", ".product .btn-compare", function (o) {
                                    ...
                                    (i = !1),
                                        ...
                                        setTimeout(function () {
                                            r.removeClass("load-more-overlay loading"), r.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), r.attr("href", "compare.html"), s.addClass("show");
                                        }, 500);
    ...
    (function (t) {
        ...
        function a(t) {
            t.preventDefault();
                Wolmart.popup({ items: { src: '<video src="assets/video/memory-of-a-woman.mp4" autoplay loop controls>', type: "inline" }, mainClass: "mfp-video-popup" }, "video");
        }
        function i(e) {
            var a = t(this);
            ...
            if (i.hasClass("disabled")) alert("Please select some product options before adding this product to your cart.");
                ...
                if (o.length)
                    ...
                    var n =
                        ...
                        (a = i.closest(".product-single").find(".product-title").text()) +
                ...
                (function (e) {
                    ...
                    var i = t(e),
                        ...
                        n =
                            ...
                            o.find(".product-image img").eq(0).attr("src") +
                            ...
                            o.find(".product-details .product-title").text() +
                            '</h4>                                        <div class="product-price mb-0">                                        <ins class="new-price">' +
                            o.find(".new-price").text() +
                            '</ins><del class="old-price">' +
                            o.find(".old-price").text() +
                            "</del></div>                                        </div></div>";
                    i.find(".product-qty-form").before(n), window.addEventListener("resize", a, { passive: !0 }), a();
    ...
    (window.onload = function () {
        (Wolmart.status = "loaded"), Wolmart.$body.addClass("loaded"), Wolmart.call(Wolmart.initLayout), Wolmart.call(Wolmart.init), (Wolmart.status = "complete"), Wolmart.$window.trigger("wolmart_complete");
    });
